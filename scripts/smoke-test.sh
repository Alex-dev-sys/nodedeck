...
initial_refresh=$(awk '$6 == "nodedeck_refresh" || $6 == "__Host-nodedeck_refresh" { print $7 }' "$cookie_jar")
...
rotated_refresh=$(awk '$6 == "nodedeck_refresh" || $6 == "__Host-nodedeck_refresh" { print $7 }' "$cookie_jar")
...
echo "NodeDeck smoke test passed"
